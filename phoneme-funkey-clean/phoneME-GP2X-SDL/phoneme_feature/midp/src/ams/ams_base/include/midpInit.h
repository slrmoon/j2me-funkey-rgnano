...
/**
 * Gets the current MIDP home directory, if one has been configured.
 *
 * @return MIDP home directory or NULL when it has not been set yet
 */
const char* midpGetHomeDir(void);
