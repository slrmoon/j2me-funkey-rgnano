    ...
    public void resize() {
        ...
        switch (screenMode) {
            ...
            case NORMAL_MODE:
                ...
                // FunKey runs MIDlets as games on a 240x240 screen. The
                // Chameleon soft button bar costs too much vertical space and
                // appears as a blue emulator-drawn strip in many Canvas games.
                // Soft keys are still handled by SoftButtonLayer.keyInput().
                buttonLayer.visible = false;
                break;
            default:
