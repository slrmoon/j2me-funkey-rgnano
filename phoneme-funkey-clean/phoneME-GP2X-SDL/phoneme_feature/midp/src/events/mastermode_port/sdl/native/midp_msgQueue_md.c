...
static const RuntimeKeyProfilePreset RuntimeKeyProfiles[] = {
  ...
  { "nokia-s40", "NOKIA/S40",
    { KEYMAP_KEY_UP, KEYMAP_KEY_DOWN, KEYMAP_KEY_LEFT, KEYMAP_KEY_RIGHT,
      KEYMAP_KEY_SELECT, KEYMAP_KEY_5, KEYMAP_KEY_SOFT1, KEYMAP_KEY_SOFT2,
      KEYMAP_KEY_ASTERISK, KEYMAP_KEY_POUND, KEYMAP_KEY_SOFT2, KEYMAP_KEY_SOFT1 } },
  { "sony-ericsson", "SONY ERICSSON",
    { KEYMAP_KEY_UP, KEYMAP_KEY_DOWN, KEYMAP_KEY_LEFT, KEYMAP_KEY_RIGHT,
      KEYMAP_KEY_SELECT, KEYMAP_KEY_5, KEYMAP_KEY_SOFT2, KEYMAP_KEY_SOFT1,
      KEYMAP_KEY_CLEAR, KEYMAP_KEY_POUND, KEYMAP_KEY_SOFT1, KEYMAP_KEY_SOFT2 } },
  { "samsung", "SAMSUNG",
    { KEYMAP_KEY_2, KEYMAP_KEY_8, KEYMAP_KEY_4, KEYMAP_KEY_6,
      KEYMAP_KEY_5, KEYMAP_KEY_SELECT, KEYMAP_KEY_SOFT1, KEYMAP_KEY_SOFT2,
      KEYMAP_KEY_ASTERISK, KEYMAP_KEY_POUND, KEYMAP_KEY_SOFT2, KEYMAP_KEY_SOFT1 } },
  { "lg", "LG",
    { KEYMAP_KEY_UP, KEYMAP_KEY_DOWN, KEYMAP_KEY_LEFT, KEYMAP_KEY_RIGHT,
      KEYMAP_KEY_SELECT, KEYMAP_KEY_5, KEYMAP_KEY_CLEAR, KEYMAP_KEY_SOFT2,
      KEYMAP_KEY_ASTERISK, KEYMAP_KEY_POUND, KEYMAP_KEY_SOFT1, KEYMAP_KEY_SOFT2 } },
  { "motorola", "MOTOROLA",
    { KEYMAP_KEY_UP, KEYMAP_KEY_DOWN, KEYMAP_KEY_LEFT, KEYMAP_KEY_RIGHT,
      KEYMAP_KEY_SELECT, KEYMAP_KEY_GAMEA, KEYMAP_KEY_SOFT1, KEYMAP_KEY_SOFT2,
