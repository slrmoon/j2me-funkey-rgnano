...
void SharedStubs::generate_brute_force_icache_flush() {
  ...
  bind_local(user_mode_flush);
    ...
    // Use the ARM EABI cacheflush syscall. The old OABI
    // "swi 0x9f0002" traps as SIGILL on modern musl kernels.
    // On Linux 2.6 and newer, r2 must be set to zero. r2's value
