...
static GLenum m3gGetGLFormat(M3GPixelFormat format)
{
    ...
    case M3G_L8:
        return GL_LUMINANCE;
    case M3G_LA4:
        return GL_M3G_LUMINANCE_ALPHA4;
    case M3G_LA8:
        return GL_LUMINANCE_ALPHA;
    case M3G_RGB8:
        return GL_RGB;
    case M3G_RGB565:
        return GL_M3G_RGB565;
    case M3G_RGB8_32:
        return GL_M3G_RGB8_32;
    case M3G_BGR8_32:
        return GL_M3G_BGR8_32;
    case M3G_RGBA8:
        return GL_RGBA;
    case M3G_BGRA8:
        return GL_M3G_BGRA8;
    ...
    case M3G_PALETTE8_RGB8_32:
        return GL_M3G_PALETTE8_RGB8_32;
...
static void m3gBindTextureObject(Image *img, M3Gbool mipmap)
{
    ...
    pixels = (M3Gubyte *) m3gMapObject(M3G_INTERFACE(img), img->data);
    if (pixels != NULL) {
        glTexImage2D(GL_TEXTURE_2D, 0, m3gGetGLFormat(img->internalFormat),
                     img->width, img->height, 0,
                     m3gGetGLFormat(img->internalFormat),
                             ...
                             M3Gsizei count)
{
	...
	//printf("[native]srcFormat:%u dstFormat:%u\n",srcFormat,dstFormat);
