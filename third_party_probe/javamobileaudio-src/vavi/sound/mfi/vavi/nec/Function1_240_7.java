...
public class Function1_240_7 implements MachineDependFunction {
    ...
    public void process(MachineDependMessage message)
        ...
        this.format =      (data[10] & 0x03) >> 1;      // 0: 4bit ADPCM (0db Center �Œ�), 1: 4bit ADPCM
        this.sampleRate =  (data[11] << 8) + data[12];  // 4000 ~ 16000 (stereo ���͔���)
...
//Debug.dump(data, 64);
    ...
    /** 0: 4bit ADPCM (0db Center �Œ�), 1: 4bit ADPCM */
    private int format;
    /** 4000 ~ 16000 (stereo ���͔���) */
    ...
    /**
     * @param format 0: 4bit ADPCM (0db Center �Œ�), 1: 4bit ADPCM (wav2mld use 1)
     */
    ...
    /**
     * ���O�� #setPcm(InputStream), #setSamplingRate(int)
     * ��p���ăt�B�[���h��ݒ肵�Ă����ĉ������B
     */
