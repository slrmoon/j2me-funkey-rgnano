...
class HeaderChunk {
    ...
    /** {@link #majorType} �� {@link #MAJOR_TYPE_RING_TONE} �̏ꍇ�A�S�ȃf�[�^ */
    public static final int MINOR_TYPE_ALL = 0x01;
    /** {@link #majorType} �� {@link #MAJOR_TYPE_RING_TONE} �̏ꍇ�A�����f�[�^  */
    public static final int MINOR_TYPE_PART = 0x02;
    /** {@link #majorType} �� {@link #MAJOR_TYPE_MUSIC} �̏ꍇ�A�Œ�  */
...
Debug.println("numberTracks: "  + tracksCount);
    ...
    /**
     * @throws InvalidMfiDataException �ŏ��� 4 bytes �� {@link #TYPE} �Ŗ����ꍇ 
     */
