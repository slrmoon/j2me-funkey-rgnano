...
//}
    ...
    /** ���݂� ticks, index is smafTrackNumber */
...
Debug.println("drums: " + midiChannel + "ch, " + value + "\n" + sb1 + "\n" + sb2 + "\n" + sb3);
    ...
    /** channel �Ɋ��蓖�Ă�ꂽ program no, index is pseudo MIDI channel */
